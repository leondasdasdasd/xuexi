      ...
      this.canvas.on("mouse:down", (event) => {
        ...
        if (this.state.currentTool == "text") {
          if (clickedObject) {
            ...
            // 设置悬浮层的位置
            textControl.style.left = `${left + 10}px`;
            textControl.style.top = `${top + 10}px`;
            // 显示悬浮层
            textControl.style.display = "block";
            // 保存第一次点击的位置
          ...
          if (clickedObject) {
            ...
            if (type == "text") {
              ...
              // 设置悬浮层的位置
              lineControl.style.left = `${left + 10}px`;
              lineControl.style.top = `${top + 10}px`;
              // 显示悬浮层
              lineControl.style.display = "block";
              // 保存第一次点击的位置
              selectedPosition = { x: left, y: top };
          ...
          {[
            {
              ...
              key: "text",
              // popoverContent: <div style={{ display: 'flex' }}>
              //     <Select
              //         value={this.state.fontSize}
              //         style={{ width: 120 }}
              //         onChange={this.fontSizeChange}
            ...
            },
            {
              ...
              //             onChange={(e) => { this.penWidthChange(e) }}
              //         />
              //     </div>
              // </div>
            },
            ...
            //     trigger="click"
            //     visible={Boolean(this.state.currentTool == item.key && item.popoverContent)}
