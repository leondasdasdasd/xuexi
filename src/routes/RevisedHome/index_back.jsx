              ...
              allScore.data.studentList ? (
                ...
                <div className={"styleNull"}>
                  <div>
                    ...
                    <Link
                      to={`/EvaluationProgramme/${this.subjectId}/${(semesterList.length && semesterList[semester].id) || null}/${evaluationList && evaluationList.id ? evaluationList.id : null}`}
                    >
