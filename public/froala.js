  ...
  ((V.RegisterPlugins = function (e) {
    ...
    (V.MODULES.clean = function (f) {
      ...
      function m(e) {
        var t = e.replace(/;;/gi, ";");
        return (
          ";" !== (t = t.replace(/^;/gi, "")).charAt(t.length) && (t += ";"),
          t
        );
      }
      function c(e) {
          ...
          if (
            ...
            a.nodeType === Node.ELEMENT_NODE &&
              (a.getAttribute("data-fr-src") &&
                ...
                a.setAttribute(
                  "data-fr-src",
                  f.helpers.sanitizeURL(E(a.getAttribute("data-fr-src"))),
                ),
              a.getAttribute("href") &&
                a.setAttribute(
                  "href",
                  f.helpers.sanitizeURL(E(a.getAttribute("href"))),
                ),
              a.getAttribute("src") &&
                a.setAttribute(
                  "src",
                  f.helpers.sanitizeURL(E(a.getAttribute("src"))),
                ),
  ...
  ((V.LinkRegExCommon = "[".concat(
    ...
    (V.MODULES.cursor = function (u) {
      ...
      function f(e) {
        ...
        if (
          ((n = n.previousSibling), !u.node.isBlock(n) && u.node.isEditable(n))
        ) {
          for (
            t = u.node.contents(n);
          ...
          if (n.nodeType === Node.TEXT_NODE) {
            ...
            if (0 === n.textContent.length)
              if (i && u.opts.keepFormatOnDelete)
                ...
                (h(n.parentNode).after(V.MARKERS), h(n.parentNode).remove());
          ...
          if (u.node.isDeletable(n))
            (h(e).replaceWith(V.MARKERS), h(n).remove());
          else if (u.node.isEmpty(n) && !u.node.isList(n))
            (h(n).remove(), h(e).replaceWith(V.MARKERS));
          else {
            for (
              u.node.isList(n) && (n = h(n).find("li").last().get(0)),
                (t = u.node.contents(n)) &&
                  "BR" === t[t.length - 1].tagName &&
      ...
      function s(e) {
        ...
        if (n && "BLOCKQUOTE" === n.tagName) {
          var r = u.node.deepestParent(e, [
            h(e).parentsUntil(u.$el, "BLOCKQUOTE").get(0),
          ]);
          r && r.nextSibling && (n = r);
        }
        if (null !== n) {
          ...
          if (
            ...
            if (u.node.isDeletable(i))
              (h(i).remove(), h(e).replaceWith(V.MARKERS));
            else if (u.node.isBlock(i) && u.node.isEditable(i))
              if (u.node.isList(i))
                if (u.node.isEmpty(n, !0))
                  (h(n).remove(), h(i).find("li").first().prepend(V.MARKERS));
                else {
                ...
                if (
                  ...
                  for (
                    o = u.node.contents(n);
                    o.length && u.node.isBlock(o[o.length - 1]);
                  )
      ...
      function n(e) {
                ...
                ((!u.node.isEmpty(u.node.blockParent(n)) ||
                  (u.node.blockParent(n).nextSibling &&
                    V.NO_DELETE_TAGS.indexOf(
                      u.node.blockParent(n).nextSibling.tagName,
                    )) < 0) &&
                  h(n).remove(),
                s(e));
            return;
        ...
        if (!u.node.isBlock(n) && u.node.isEditable(n)) {
          ...
          if (u.node.isDeletable(n))
            ...
            e.previousSibling
              ? (h(n).find("li").first().prepend(e),
                u.cursorLists._backspace(e))
              : (h(n).find("li").first().prepend(V.MARKERS), h(e).remove());
          else if (
            ((t = u.node.contents(n)) &&
              "BR" === t[0].tagName &&
              h(t[0]).remove(),
        ...
        if (null === o)
          ...
          (r = u.html.defaultTag()) &&
            ...
            o.tagName === r.toUpperCase() &&
              (d = u.node.openTagString(h(o).clone().removeAttr("id").get(0))));
          do {
            if (
              ((i = i.parentNode), !t || i !== o || (t && !u.node.isBlock(o)))
            )
              if (
                ((l += u.node.closeTagString(i)), i === o && u.node.isBlock(o))
              )
                c = d + c;
              else {
                var p =
                  ("A" === i.tagName || u.node.hasClass(i, "fa")) && m(e, i)
                    ? "fr-to-remove"
                    : "";
          ...
          ((a =
            ...
            a +
            c +
            (e.parentNode === o && u.node.isBlock(o) ? "" : V.INVISIBLE_SPACE) +
            V.MARKERS),
            u.node.isBlock(o) &&
              !h(o).find("*").last().is("br") &&
              h(o).append("<br/>"),
            ...
            (s = (s =
              !t && u.node.isBlock(o)
                ? u.node.openTagString(o) + h(o).html() + f
                : u.node.openTagString(o) +
                  h(o).html() +
                  u.node.closeTagString(o)).replace(
      ...
      function v(e, t, n) {
        ...
        if (null === r)
          ...
          do {
            ...
            if (
              ...
              if (!t || o !== r || (t && !u.node.isBlock(r))) {
                ...
                var c =
                  ("A" == o.tagName && m(e, o)) || u.node.hasClass(o, "fa")
                    ? "fr-to-remove"
                    : "";
                s =
                  u.node.openTagString(
                    h(o).clone().addClass(c).removeAttr("id").get(0),
                  ) + s;
          ...
          var p =
            u.node.openTagString(r) + h(r).html() + u.node.closeTagString(r);
        ...
        enter: function b(e) {
          ...
          for (var n = t.parentNode; n && !u.node.isElement(n); ) {
            if ("false" === n.getAttribute("contenteditable"))
              return (h(t).replaceWith(V.MARKERS), u.selection.restore(), !1);
                ...
                ? !c(t) || e || r
                  ? (function s(e, t, n) {
                      ...
                      if (o && "TABLE" === o.tagName)
                        return (
                          h(o).find("td, th").first().prepend(e),
                          s(e, t, n)
                        );
                      if (o && "BLOCKQUOTE" === o.tagName)
                        if (g(e, o)) {
                          if (!t)
                            return (
                              (r = u.html.defaultTag())
                                ...
                                : h(o).before("".concat(V.MARKERS, "<br>")),
                              h(e).remove(),
                              !1
                            );
                          ...
                          if (("PRE" === o.tagName && (t = !0), t))
                            ...
                            if (u.opts.keepFormatOnDelete) {
                              for (
                                ...
                                i !== o && !u.node.isElement(i);
                              )
                                ((i = i.parentNode),
                                  (a =
                                    u.node.openTagString(i) +
                                    a +
                              ...
                              h(o).before(
                                ""
                                  .concat(
                                    u.node.openTagString(
                                      h(o).clone().removeAttr("id").get(0),
                                    ),
                                    "<br>",
                                  )
                                  .concat(u.node.closeTagString(o)),
                              );
                          }
                        else h(o).before("<br>");
                        h(e).remove();
              ...
              : a(t)
                ? c(t) && g(t, h(t).parents("li").first().get(0))
                  ...
                  : (function l(e) {
                      for (
                        var t =
                            0 < h(e).parentsUntil(u.$el, "BLOCKQUOTE").length,
                          n = u.node.deepestParent(e, [], !t),
                          r = n;
                        n &&
                        !n.previousSibling &&
                        ...
                        V.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) <
                          0;
                      )
                        n = n.parentElement;
                      if (n && "BLOCKQUOTE" === n.tagName) {
                          ...
                          if (a && V.NO_DELETE_TAGS.indexOf(a.tagName) < 0) {
                                ...
                                if (u.node.isEmpty(a) && !u.node.isList(a))
                                  ...
                                  if (u.node.isEmpty(n))
                                    ...
                                    u.node.isBlock(s[s.length - 1])
                                      ? h(s[s.length - 1]).append(r.innerHTML)
                                      : h(a).append(r.innerHTML);
                                  }
                                  (h(r).remove(),
                            ...
                            a ||
                              ...
                              0 ===
                                ...
                                : u.node.isEmpty(n) &&
                                  n.parentNode &&
                                  u.node.isEditable(n.parentNode) &&
                                  n.parentNode != u.el &&
      ...
      function g() {
        ...
        (f.$wp.prepend(M(p(M(N)))),
          ...
          "rtl" === f.opts.direction &&
            b.css("left", "auto").css("right", 0).attr("direction", "rtl"),
          e++);
      }
      function m(e) {
        for (
        ...
        _init: function x() {
          ...
          for (var n, r, o, i = !(f.ul = !0), a = 0, s = 0; s < e.length; s++) {
            ...
            if (
              ...
              0 <= c.indexOf(A, c.length - A.length) ||
              m(A) ||
              v()
            ) {
              if (
                (null !== (n = l[1]) &&
                  !(0 == n.indexOf("TRIAL")
                    ? ((n = new Date(n.replace(/TRIAL/, ""))),
                      new Date(n) < new Date() && ((T = y), 1))
                    : new Date(n) < new Date(M(C)))) ||
                !(0 < (A || "").length) ||
                m(A) ||
                v()
              ) {
    ...
    (V.MODULES.format = function (b) {
        ...
        if (e) {
          ...
          if (e) {
            if (b.node.isBlock(e) && "HR" !== e.tagName)
              return (
                b.node.hasClass(e.firstChild, "fr-marker")
            ...
            if (o) {
              ...
              for (
                ...
                c && !c.nextSibling && !b.node.isElement(c);
              )
                c = c.parentNode;
              if (c) {
                var d = c.nextSibling;
      ...
      function n(e, t) {
        ...
        if (
          ...
          do {
            for (
              r = b.$el.find("".concat(S(e, t), " > ").concat(S(e, t))), n = 0;
              n < r.length;
              n++
            )
          ...
          for (n = 0; n < o.length; n++) {
            var i = E(o[n]);
            !0 === i.data("type")
              ? T(i.get(0).nextSibling, S(e, t)) && i.next().prepend(i)
              : T(i.get(0).previousSibling, S(e, t)) && i.prev().append(i);
          }
          b.selection.restore();
        }
      }
      function y(e, t, n, r) {
        ...
        if (e.parents(t).length || void 0 === t) {
          ...
          for (
            ;
            !(
              b.node.isBlock(l.parent().get(0)) ||
              (void 0 !== t && T(l.get(0), S(t, n)))
            );
          )
          ...
          return (
            ...
            (i = l
              ...
              .replace(
                /<span id="mark"><\/span>/,
                a +
                  b.node.closeTagString(l.get(0)) +
                  s +
                  c +
                  a +
                  b.node.openTagString(l.get(0)) +
                  s,
              )),
            l.replaceWith(
              b.node.openTagString(l.get(0)) +
          ...
          for (var o = b.node.contents(e.get(0)), i = 0; i < o.length; i++) {
            ...
            if (
              ...
              if (0 < E(a).find(".fr-marker").length) t = m(E(a), t, n, r);
                ...
                for (
                  var s = E(a).find(n || "*:not(br)"), l = s.length - 1;
                  0 <= l;
                  l--
                ) {
                  var c = s[l];
                ...
                T(a, S(n, r))
                  ? b.node.isBlock(a) ||
                    b.node.hasClass(a, "fr-clone") ||
                    (a.outerHTML = a.innerHTML)
                  : void 0 === n &&
                    a.nodeType === Node.ELEMENT_NODE &&
                    b.node.isBlock(a) &&
                    "TABLE" !== a.tagName &&
                    b.node.clearAttributes(a);
              }
      ...
      function t(e, t) {
        ...
        if (b.selection.isCollapsed()) {
          ...
          if (
            ...
            null === t ||
              ("color" === e &&
                0 < b.$el.find(".fr-marker").parents("u, a").length))
          ) {
            ...
            for (n = 0; n < d.length; n++)
              if (
                ...
                for (
                  ;
                  b.node.isFirstSibling(r.get(0)) &&
                  !r.parent().is(b.$el) &&
                  !b.node.isElement(r.parent().get(0)) &&
                  !b.node.isBlock(r.parent().get(0));
                )
                  r.parent().before(r);
              else
                for (
                  ;
                  b.node.isLastSibling(r.get(0)) &&
                  !r.parent().is(b.$el) &&
                  !b.node.isElement(r.parent().get(0)) &&
                  !b.node.isBlock(r.parent().get(0));
                )
          ...
          (b.$el.find("span[style] span[style]").each(function () {
            if (0 <= E(this).attr("style").indexOf("font-size")) {
              ...
              0 <= e.attr("style").indexOf("background-color") &&
                (E(this).attr(
                  "style",
                  "".concat(E(this).attr("style"), ";").concat(e.attr("style")),
                ),
      ...
      function v(e, t, n) {
        ...
        for (r = a.length - 1; 0 <= r; r--)
          ((o = a[r]),
            (i = t),
            0 === E(o).attr("style").indexOf("".concat(i, ":")) ||
              0 <= E(o).attr("style").indexOf(";".concat(i, ":")) ||
              0 <= E(o).attr("style").indexOf("; ".concat(i, ":")) ||
              s.push(a[r]));
        if ((a = a.not(s)).length) {
          for (
            ...
            (p = p.parentNode),
              ...
              (c =
                b.node.openTagString(E(p).clone().addClass("fr-split").get(0)) +
                c),
              a.get(0) !== p &&
                ((d += b.node.closeTagString(p)),
                (f =
                  b.node.openTagString(
                    E(p).clone().addClass("fr-split").get(0),
                  ) + f)),
              a.get(0) !== p;
          );
          var u = ""
      ...
      function o(e, t) {
        ...
        for (
          var o = r;
          o && o.nodeType === Node.ELEMENT_NODE && !T(o, S(e, t));
        )
          o = o.firstChild;
        ...
        for (
          ...
          i && i.nodeType === Node.ELEMENT_NODE && i !== b.el && !T(i, S(e, t));
        )
          i = i.parentNode;
        return !(
          !i ||
    ...
    (V.MODULES.selection = function (T) {
          ...
          for (t = 0; t < n.length; t++)
            if (n[t].startContainer !== T.doc || T.browser.msie) {
              ...
              if (
                ((void 0 !== i && i) ||
                  !o ||
                  (y(".fr-marker").remove(), T.selection.setAtEnd(T.el)),
                T.el.normalize(),
                T.browser.safari && !o)
              )
                try {
          ...
          if (0 < a.length) {
            ...
            try {
              ...
              if (o.nextSibling === a || a.nextSibling === o) {
                ...
                if (
                  (h && (T.node.isVoid(h) || T.node.isBlock(h)) && (h = null),
      ...
      function o(e) {
        ...
        if (T.win.getSelection) {
          ...
          T.doc.selection &&
            ...
            ((n = (t =
              T.doc.selection.createRange()).duplicate()).moveToElementText(e),
      ...
      function r(e, t) {
        ...
        for (
          ...
          n &&
          (T.node.isBlock(n) ||
            (t && !T.node.isVoid(n) && n.nodeType === Node.ELEMENT_NODE));
        )
          n = (e = n).firstChild;
      ...
      return {
                ...
                y(r.childNodes[n.endOffset]).text() === s()
                  ...
                  : !n.collapsed &&
                    ...
                    : !n.collapsed &&
                      0 < r.childNodes.length &&
                      r.childNodes[n.endOffset] &&
                      (t = r.childNodes[n.endOffset].previousSibling)
        ...
        remove: function $() {
          ...
          for (e = 0; e < r.length; e++)
            for (
              ...
              !(
                t(o) ||
                T.node.isBlock(o.parentNode) ||
                T.$el.is(o.parentNode) ||
                T.node.hasClass(o.parentNode, "fr-inner")
              );
            )
          ...
          if (
            ...
            !(function S(e, t) {
              ...
              0 <= ["TD", "TH"].indexOf(e.get(0).tagName) &&
                ...
                (T.node.hasClass(n[0], "fr-marker") ||
                  ("BR" == n[0].tagName &&
                    T.node.hasClass(n[0].nextElementSibling, "fr-marker"))) &&
            ...
            if (s.length)
              ...
              for (
                ...
                if (d) {
                  ...
                  ((d = y(l).clone().attr("data-type", !1)), y(l).after(d));
              }
          }
        ...
        blocks: function h() {
          ...
          if (p() && r.rangeCount) {
            ...
            for (e = 0; e < o.length; e++) {
              ...
              ((T.node.isBlock(a) || T.node.hasClass(a, "fr-inner")) &&
                n.indexOf(a) < 0 &&
                n.push(a),
                (t = T.node.blockParent(a)) && n.indexOf(t) < 0 && n.push(t));
              for (var l = [], c = a; c !== s && c !== T.el; )
                (l.indexOf(c) < 0 && c.children && c.children.length
                  ? (l.push(c), (c = c.children[0]))
                  : c.nextSibling
                    ? (c = c.nextSibling)
                    : c.parentNode && ((c = c.parentNode), l.push(c)),
                  T.node.isBlock(c) &&
                    l.indexOf(c) < 0 &&
                    n.indexOf(c) < 0 &&
                    (c !== s || 0 < i.endOffset) &&
          ...
          return n
            ? (T.node.isBlock(n)
                ...
                : "BR" === n.tagName
                  ...
                  : y(n).after(V.MARKERS),
              !0)
            : !!t && (T.node.isBlock(e) ? r(e) : y(e).before(V.MARKERS), !0);
        },
        setAfter: function m(e, t) {
          ...
          for (
            ...
            n = n.nextSibling;
          return n
            ? (T.node.isBlock(n) ? r(n) : y(n).before(V.MARKERS), !0)
            : !!t && (T.node.isBlock(e) ? i(e) : y(e).after(V.MARKERS), !0);
        },
        rangeElement: f,
      };
    }),
    ...
    (V.MODULES.html = function (w) {
      ...
      function e(e) {
        ...
        ((r = p.merge(r, w.opts.htmlAllowedEmptyTags)),
          (r =
            void 0 === e
              ? p.merge(r, V.BLOCK_TAGS)
              : p.merge(r, V.NO_DELETE_TAGS)),
                  ...
                  if (c[f].selectorText && 0 < c[f].style.cssText.length) {
                    ...
                    for (o = 0; o < h.length; o++) {
                      ...
                      h[o].getAttribute("style")
                        ...
                        a[h[o]] || (a[h[o]] = {}));
                      for (
                        var g = 1e3 * d + L(c[f].selectorText),
            ...
            for (var o = w.selection.ranges(), i = 0; i < o.length; i++) {
              ...
              (a.appendChild(o[i].cloneContents()),
                e(
                  ...
                  null !== n &&
                  (0 <= p(n).parents().toArray().indexOf(w.el) || n === w.el)
                    ? n
                    : null),
                ),
          ...
          if (
            ...
            if (o) {
              w.node.isLastSibling(o) &&
                p(o).parent().hasClass("fr-deletable") &&
                p(o).insertAfter(p(o).parent());
                    ...
                    (r = (function s(e) {
                      ...
                      for (
                        ...
                        w.node.isBlock(o.previousSibling) ||
                          (o.previousSibling &&
                            !w.node.isEmpty(o) &&
                            p("<br>").insertAfter(o.previousSibling),
                          (o.outerHTML = o.innerHTML));
                      }
                      return t.innerHTML;
                    })(r)),
    ...
    (V.MODULES.keys = function (d) {
      ...
      function h(e) {
        (["INPUT", "BUTTON", "TEXTAREA"].indexOf(e.target && e.target.tagName) <
          0 && e.preventDefault(),
          e.stopPropagation(),
          "" === d.selection.text() && "IMG" != d.selection.element().tagName
            ? d.cursor.del()
            : d.selection.remove(),
          d.placeholder.refresh());
      }
    ...
    (V.MODULES.paste = function (M) {
        ...
        return (
          (function o() {
            (M.selection.save(),
              ...
              i
                ? (i.html(""),
                  M.browser.edge && M.opts.iframe && M.$el.append(i))
                : ((i = x(
                  ...
                  M.browser.webkit || M.browser.mozilla
                    ? (i.css("top", M.$sc.scrollTop()), M.$el.after(i))
                    : M.browser.edge && M.opts.iframe
                      ? M.$el.append(i)
                      : M.$box.after(i),
      ...
      function d() {
        ...
        (t && "string" == typeof t && (a = t),
          (!e || (e && !1 !== M.events.trigger("paste.wordPaste", [a]))) &&
            o(a, e));
      }
      function w(e) {
        for (var t = "", n = 0; n++ < e; ) t += "&nbsp;";
      ...
      function o(e, t, n) {
        ...
        if (!t)
          if (
            ...
            e = M.clean.html(
              e,
              M.opts.pasteDeniedTags,
              M.opts.pasteDeniedAttrs,
            );
          else {
        ...
        if (("string" == typeof d && (e = d), "" !== e)) {
          ...
          0 <= (f.innerHTML = e).indexOf("<body>")
            ? (M.html.cleanBlankSpaces(f), M.spaces.normalize(f, !0))
            : M.spaces.normalize(f);
              ...
              (e = (function N(e) {
                ...
                var r = n.querySelectorAll(
                  "*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not("
                    ...
                    .concat(M.opts.htmlAllowedEmptyTags.join("):not("), ")"),
                );
                for (; r.length; ) {
                  for (t = 0; t < r.length; t++)
      ...
      function $(e) {
        ...
        for (
          ...
          if (M.html.defaultTag() && "div" !== M.html.defaultTag())
            o.querySelector(M.html.blockTagsQuery())
              ? (o.outerHTML = o.innerHTML)
              : (o.outerHTML = "<"
                  .concat(M.html.defaultTag(), ">")
                  .concat(o.innerHTML, "</")
                  .concat(M.html.defaultTag(), ">"));
          else {
    ...
    (V.MODULES.popups = function (f) {
      ...
      function l(e, t) {
        ...
        (o.addClass(
          "fr-popup"
            .concat(f.helpers.isMobile() ? " fr-mobile" : " fr-desktop")
        ...
        return {
          ...
          _editorKeydown: function (e) {
            ...
            t.keys.ctrlKey(e) ||
              ...
              (g(r) && o.findVisible(".fr-back").length
          ...
          _preventFocus: function (e) {
            ...
            ("mouseup" === e.type ||
              ...
              "mouseup" !== e.type ||
                ...
                f.button.hideActiveDropdowns(o),
          ...
          _windowMouseup: function (e) {
            ...
            o.isVisible() &&
              i() &&
              (e.stopPropagation(), t.markers.remove(), t.popups.hide(r), b());
          },
      ...
      function c(e, t) {
        (f.events.on("mouseup", e._editorMouseup, !0),
          ...
          f.events.on("blur", function () {
            (m() && f.markers.remove(),
              f.helpers.isMobile()
                ? u[t].hasClass("focused")
                  ? (v(), u[t].removeClass("focused"))
                  : u[t].addClass("focused")
                : u[t].find("iframe").length || v());
          }),
          f.$wp &&
            !f.helpers.isMobile() &&
            f.events.$on(f.$wp, "scroll.popup".concat(t), e._repositionPopup),
          ...
          f.events.on(
            ...
            function () {
              f.core.sameInstance(u[t]) &&
                (d("body").first().append(u[t]), u[t].removeClass("fr-active"));
            },
            !0,
          ));
      }
          ...
          show: function y(e, t, n, r, o) {
            if (
              (g(e) ||
                (m() && 0 < f.$el.find(".fr-marker").length
                  ? (f.events.disableBlur(), f.selection.restore())
                  : m() ||
                    (f.events.disableBlur(),
                    f.events.focus(),
                    f.events.enableBlur())),
            ...
            (s.is(f.$tb)
              ...
              f.opts.toolbarBottom &&
                ...
                f.$tb &&
                s.get(0) === f.$tb.get(0) &&
                (u[e].addClass("fr-above"), n && (n -= u[e].outerHeight())),
              o && (t -= u[e].width() / 2),
              t + u[e].outerWidth() > f.$sc.offset().left + f.$sc.width() &&
                (t -=
                  t + u[e].outerWidth() - f.$sc.offset().left - f.$sc.width()),
              t < f.$sc.offset().left &&
                "rtl" === f.opts.direction &&
    ...
    (V.MODULES.accessibility = function (f) {
      ...
      function s(e) {
        ...
        var r = e.index(
          f.$tb
            .find(".fr-more-toolbar.fr-expanded > button.fr-command")
            .first(),
        );
        if (0 < r && -1 !== t) {
    ...
    (V.MODULES.position = function (S) {
      ...
      function o() {
        ...
        if ((0 === e.top && 0 === e.left && 0 === e.width) || 0 === e.height) {
          var t = !1;
          0 === S.$el.find(".fr-marker").length &&
            (S.selection.save(), (t = !0));
          ...
          (n.css("display", "none"),
            ...
            (e.top =
              r &&
              r.top -
                ((S.helpers.isMobile() && !S.helpers.isIOS()) || S.opts.iframe
                  ? 0
                  : S.helpers.scrollTop())),
            (e.right = 1),
            (e.bottom = 1),
      ...
      function i(e, t, n, r) {
        ...
        var s = (function l(e, t) {
          ...
          return (
            t + n > S.$sc.get(0).clientWidth - 10 &&
              (t = S.$sc.get(0).clientWidth - n - 10),
            t < 0 && (t = 10),
            t
          );
        })(n, e);
            ...
            n.css(
              ...
              (function c(e, t, n) {
                ...
                if (
                  !S.helpers.isMobile() &&
                  S.$tb &&
                  e.parent().get(0) !== S.$tb.get(0)
                ) {
                  var o = e.parent().offset().top,
                    i = t - r - (n || 0);
                  e.parent().get(0) === S.$sc.get(0) &&
                    (o -= e.parent().position().top);
                  var a = S.$sc.get(0).clientHeight;
                  o + t + r > S.$sc.offset().top + a &&
                  0 < e.parent().offset().top + i &&
                  0 < i
                    ? i > S.$wp.scrollTop() && ((t = i), e.addClass("fr-above"))
      ...
      function t(e) {
        ...
        if (S.core.hasFocus() || 0 < S.$tb.findVisible("input:focus").length) {
          var a = S.helpers.scrollTop(),
            s = Math.min(
              Math.max(a - S.$tb.parent().offset().top, 0),
              S.$tb.parent().outerHeight() - n.outerHeight(),
            );
          if (
            (s !== r &&
              s !== o &&
              ...
              n.outerHeight() < a - S.$tb.parent().offset().top &&
              ...
              n.data(
                ...
                setTimeout(function () {
                  var e = S.helpers.scrollTop(),
                    t = Math.min(
                      Math.max(e - S.$tb.parent().offset().top, 0),
                      S.$tb.parent().outerHeight() - n.outerHeight(),
                    );
                  (0 < t &&
                    "BODY" === S.$tb.parent().get(0).tagName &&
                    (t += S.$tb.parent().position().top),
                    t !== r &&
      ...
      function n(e) {
        if (e.offsetWidth) {
          var t = T(e),
            ...
            o = T(
              "body" === S.opts.scrollableContainer
                ? S.o_win
                : S.opts.scrollableContainer,
            ).outerHeight(),
            i = 0,
            a = 0;
          "body" !== S.opts.scrollableContainer &&
            ((i = S.$sc.offset().top), (a = T(S.o_win).outerHeight() - i - o));
          var s =
              "body" === S.opts.scrollableContainer ? S.helpers.scrollTop() : i,
            l = t.is(".fr-sticky-on");
          ...
          if (
            ...
            (p || t.css("position", "fixed"),
              ...
              t.data(
                "top",
                S.node.hasClass(t.get(0), "fr-top") ? t.css("top") : "auto",
              ),
              t.data(
                "bottom",
                S.node.hasClass(t.get(0), "fr-bottom")
                  ? t.css("bottom")
                  : "auto",
              ));
          }
          var u = S.helpers.getPX(t.data("top")),
            ...
            g =
              ...
              (S.helpers.isInViewPort(S.$sc.get(0)) ||
                "body" === S.opts.scrollableContainer),
            m =
              r.bottom &&
              (function E() {
          ...
          if (g || m) {
            ...
            (t.css(
              "width",
              "".concat(c.get(0).getBoundingClientRect().width - v, "px"),
            ),
              l ||
                ...
                t.css("top") &&
                  ("auto" !== t.data("top")
                    ? t.css("top", S.helpers.getPX(t.data("top")) + i)
                    : t.data("top", "auto")),
                t.css("bottom") &&
                  ("auto" !== t.data("bottom")
                    ? t.css("bottom", S.helpers.getPX(t.data("bottom")) + a)
                    : t.css("bottom", "auto"))));
          } else
      ...
      function r() {
        if (
          (S.helpers.requestAnimationFrame()(r),
    ...
    (V.MODULES.toolbar = function (m) {
        ...
        if (v !== m.helpers.screenSize()) {
          ...
          e)) {
            ...
            if (o.buttons) {
              ...
              e.showMoreButtons &&
                (i = b('<div class="fr-more-toolbar"></div>').data(
                  "name",
      ...
      return {
        _init: function p() {
          if (((m.$sc = b(m.opts.scrollableContainer).first()), !m.$wp))
            return !1;
          (m.opts.toolbarInline ||
            m.opts.toolbarBottom ||
            ...
            m.opts.toolbarContainer
              ? (m.shared.$tb
                  ...
                  : ((m.shared.$tb = b(m.doc.createElement("DIV"))),
    ...
    (E.Bootstrap = function (e, t, n) {
      ...
      ("function" == typeof t && ((n = t), (t = {})),
        ...
        (this.opts = Object.assign(
          {},
          Object.assign({}, E.DEFAULTS, r, "object" === M(t) && t),
        )));
      ...
      if (
        ...
        for (var t in this.shared)
          Object.prototype.hasOwnProperty.call(this.shared, t) &&
            ((this.shared[t] = null), (E.SHARED[this.sid][t] = null));
